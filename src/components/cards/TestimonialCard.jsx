...
const TestimonialCard = ({ quote, name, color, initial, location, rating = 5 }) => {
    return (
        <div className="bg-gray-50 p-5 md:p-6 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col h-full group">
            ...
            <p className="text-sm md:text-base text-gray-700 italic leading-relaxed mb-4 flex-grow -mt-2">
                {quote}
            </p>
            ...
            <div className="flex items-center gap-3 border-t border-gray-200 pt-4 mt-auto">
                ...
                <div>
                    <h4 className="font-bold text-[var(--color-maroon)] leading-none mb-1 text-sm">{name}</h4>
