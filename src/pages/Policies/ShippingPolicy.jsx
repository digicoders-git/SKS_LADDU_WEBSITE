        ...
        <div className="bg-[var(--color-accent)] text-[var(--color-primary)] font-[var(--font-main)] min-h-screen">
            ...
            <section className="py-24 px-8 md:px-24 max-w-4xl mx-auto">
                <div className="bg-white p-12 rounded-[40px] shadow-2xl border border-black/5">
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif underline decoration-[var(--color-secondary)]">Delivery Timeline</h2>
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif underline decoration-[var(--color-secondary)]">Shipping Charges</h2>
                    <p className="mb-6 leading-relaxed text-gray-700">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif underline decoration-[var(--color-secondary)]">Packaging</h2>
                    <p className="mb-6 leading-relaxed text-gray-700">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif underline decoration-[var(--color-secondary)]">Tracking</h2>
                    <p className="mb-6 leading-relaxed text-gray-700">
                        Once your order is shipped, you will receive a tracking ID via email/SMS to monitor your sweet parcel's journey.
                    </p>

                    <div className="mt-12 p-6 bg-[var(--color-accent)] rounded-2xl italic text-gray-600 border-l-4 border-[var(--color-secondary)]">
