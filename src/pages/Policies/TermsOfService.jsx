        ...
        <div className="bg-[var(--color-accent)] text-[var(--color-primary)] font-[var(--font-main)] min-h-screen">
            ...
            <section className="py-24 px-8 md:px-24 max-w-4xl mx-auto">
                <div className="bg-white p-12 rounded-[40px] shadow-2xl border border-black/5">
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif">1. Use of Website</h2>
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif">2. Product Accuracy</h2>
                    <p className="mb-8 leading-relaxed text-gray-700">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif">3. Pricing and Payment</h2>
                    <p className="mb-8 leading-relaxed text-gray-700">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif">4. Intellectual Property</h2>
                    <p className="mb-8 leading-relaxed text-gray-700">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-maroon)] mb-6 font-serif">5. Changes to Terms</h2>
                    <p className="mb-8 leading-relaxed text-gray-700">
