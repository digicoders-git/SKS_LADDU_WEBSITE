...
import { ShoppingBag, Trash2, MapPin, CreditCard, CheckCircle2 } from 'lucide-react';
...
const Shop = () => {
    ...
    return (
        <div className="bg-gray-50 text-gray-800 font-[var(--font-body)] min-h-screen pb-20">
            {/* Title Section */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-2 space-y-10">
                            ...
                            <div ref={addToRefs} className="scroll-section space-y-6">
                                ...
                                {cart.map((item) => (
                                    <div key={item.uniqueId} className="bg-white p-4 md:p-6 rounded-3xl flex items-center gap-4 md:gap-6 border border-gray-50 shadow-sm hover:shadow-md transition-shadow">
                                        <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl overflow-hidden border border-gray-100 flex-shrink-0">
                                        ...
                                        <div className="flex-grow">
                                            <div className="flex justify-between items-start">
                                                ...
                                                <p className="font-bold text-lg md:text-xl text-[var(--color-maroon)]">₹{item.price}</p>
                                            </div>
                                            <div className="mt-3 md:mt-4 flex items-center justify-between">
                                                <p className="text-[10px] md:text-xs text-gray-400 italic">Net Quantity: 1.0 kg</p>
                                                <button
                                                    onClick={() => removeFromCart(item.uniqueId)}
                                                    className="flex items-center gap-2 text-red-600 hover:text-red-800 font-extrabold text-[12px] md:text-sm uppercase bg-transparent border-none p-0 outline-none transition-all"
                                                >
                                                    <Trash2 size={18} />
                                                    <span className="border-b-2 border-red-600">Remove</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="lg:col-span-1">
                            <div ref={addToRefs} className="scroll-section sticky top-24">
                                <h2 className="text-lg md:text-xl font-bold text-gray-700 mb-6 flex items-center gap-3 font-[var(--font-heading)]">
                                    Final Bill
                                </h2>
                                <div className="bg-white p-6 md:p-8 rounded-[40px] border border-gray-100 shadow-xl">
